...
const Color kGold = Color(0xFFFF5500);
...
const Color pGold = Color(0xFFFF5500);
const Color pEmerald = Color(0xFF00C896);
const Color pAzure = Color(0xFF38BDF8);
const Color pBg = Color(0xFF06060F);

const cBg = Color(0xFF080810);
const cGold = Color(0xFFFF5500);
const cGold2 = Color(0xFFFF8844);
const cGold3 = Color(0xFFB8861E);
const cEmerald = Color(0xFF2ECC71);
const cAzure = Color(0xFF38BDF8);
const cRose = Color(0xFFE74C3C);
...
class AppColors {
  ...
  Color get bg => theme.isDark ? const Color(0xFF0A0A0F) : const Color(0xFFF5F0E8);
  Color get card => theme.isDark ? const Color(0x14FFFFFF) : const Color(0xFFFFFFFF);
  Color get cardBorder => theme.isDark ? const Color(0x18FFFFFF) : const Color(0x0F000000);
  Color get cardSolid => theme.isDark ? const Color(0xFF151520) : const Color(0xFFFFFFFF);
  Color get gold => theme.isDark ? const Color(0xFFFF5500) : const Color(0xFFB8860B);
  Color get gold2 => theme.isDark ? const Color(0xFFFF8844) : const Color(0xFFD4A843);
  Color get gold3 => theme.isDark ? const Color(0x1AFF5500) : const Color(0x1FB8860B);
  Color get emerald => theme.isDark ? const Color(0xFF2ECC71) : const Color(0xFF0A7A5A);
